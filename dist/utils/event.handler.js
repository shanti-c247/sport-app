...
exports.eventRandomData = void 0;
 ...
 */
const eventRandomData = (type) => {
    const commonData = {
        title: { type: 'string', example: faker_1.faker.person.fullName() },
    ...
    switch (type) {
        ...
        case 'updateEventRequest':
            return Object.assign({}, commonUpdateData);
        default:
            throw new Error(`Unsupported type: ${type}`);
    }
};
exports.eventRandomData = eventRandomData;
